...
function encherCopo (copo, liquido){
    if(copo instanceof liquido){
        console.log(`O objeto ${copo.nome} é uma instancia de ${liquido.name}`);
    } else {
        console.log(`O objeto ${copo.nome} não é uma instancia de ${liquido.name}`);
    }
}
